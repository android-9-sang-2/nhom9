...
// setup các hàm thêm xóa sửa cho database.
public class MyDatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String COLUMN_NOTE_ID ="Note_Id";// Bảng gồm ID, tiêu đề, nội dung
...
//* trước mỗi lần mở kết nối database cần đóng nó lại khi thực hiện xong thao tác
    public void addNote(Note note) {
        ...
        values.put(COLUMN_NOTE_TITLE, note.getNoteTitle());/// truyền vào nội dung và tiêu đề
...
// truy vấn tới bằng cần tcacs động thông tin tới. cần có id của bảng
...
// đưa ra danh sách các bảng node bang câu lệnh query seclect
    ...
    public List<Note> getAllNotes() {
        ...
        // Duyệt trên con trỏ, và thêm vào danh sách. danh sach ở đây la danh sach cac bang node
...
// delete note phải dựa vào id, mỗi node dc sinh d khi tao.
