...
import com.example.chanh.toeic.Activity.QuestionGroupSliderActivity;
...
public class GroupQuestionPageFragment extends android.support.v4.app.Fragment{
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        questionGroups = (ArrayList<QuestionGroup>) questionGroupSliderActivity.getData();
    ...
    public QuestionGroup getItem(int position){ // lay gia tri dua theo vi tri
        return questionGroups.get(position);
    }
